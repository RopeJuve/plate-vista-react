...
function Appetizers({ openDetail }) {
  const [items] = useState([
    { id: 1, name: 'Bruschetta', description: 'Grilled bread topped with diced tomatoes and basil.', price: 8.99 },
    { id: 2, name: 'Stuffed Mushrooms', description: 'Mushrooms stuffed with garlic, breadcrumbs, and cheese.', price: 10.99 },
