// src/FamilyStyleMeals.jsx
import React, { useState } from 'react';

function FamilyStyleMeals({ openDetail }) {
  const [items] = useState([
    { id: 1, name: 'Lasagna', description: 'Layered pasta with ricotta, mozzarella, and marinara sauce.', price: 29.99 },
    { id: 2, name: 'Spaghetti Bolognese', description: 'Spaghetti with a rich, meaty tomato sauce.', price: 19.99 },
